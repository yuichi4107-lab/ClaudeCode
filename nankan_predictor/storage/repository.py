...
class Repository:
    ...
    def upsert_race(self, race_info: dict) -> None:
        ...
        INSERT INTO races (race_id, venue_code, venue_name, race_date, race_number,
                           race_name, distance, track_type, track_condition, weather,
                           field_size, scraped_at)
    ...
    def upsert_horse_history(self, horse_id: str, rows: list[dict]) -> None:
        ...
        INSERT INTO horse_history_cache
            (horse_id, race_date, venue_name, race_name, distance, field_size,
             gate_number, horse_number, popularity_rank, finish_position,
    ...
    def get_entries_in_range(self, from_date: str, to_date: str) -> pd.DataFrame:
        ...
        SELECT e.*, r.venue_code, r.venue_name, r.race_date, r.distance,
               r.track_type, r.track_condition, r.field_size, r.race_number
        FROM race_entries e
